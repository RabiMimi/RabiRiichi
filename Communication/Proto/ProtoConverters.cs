...
namespace RabiRiichi.Communication.Proto {
  public class ProtoConverters {
    ...
    public static RyuukyokuActionMsg ConvertRyuukyokuAction([Consumes] RyuukyokuAction action) {
      return new() { Reason = action.reason };
    }
